package com.greenfox.workshopdi.services;
...
public class UtilityService {
  ...
  public String validateEmail(String emailAdress){
...
// - Have two endpoints (one for encoding and one for decoding) with a `text` and `number`
// query param
// - Have a link at the main page for both
// - For encoding use the `number` value, for decoding use the `-number`
// value when calling the caesar() method.
